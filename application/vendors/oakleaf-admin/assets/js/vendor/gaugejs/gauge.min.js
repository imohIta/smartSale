...
this.configDisplayScale();return this;};BaseGauge.prototype.configDisplayScale=function(){var backingStoreoakleafRatio,deviceoakleafRatio,height,prevDisplayScale,width;prevDisplayScale=this.displayScale;if(this.options.highDpiSupport===false){delete this.displayScale;}else{deviceoakleafRatio=window.deviceoakleafRatio||1;backingStoreoakleafRatio=this.ctx.webkitBackingStoreoakleafRatio||this.ctx.mozBackingStoreoakleafRatio||this.ctx.msBackingStoreoakleafRatio||this.ctx.oBackingStoreoakleafRatio||this.ctx.backingStoreoakleafRatio||1;this.displayScale=deviceoakleafRatio/backingStoreoakleafRatio;}
