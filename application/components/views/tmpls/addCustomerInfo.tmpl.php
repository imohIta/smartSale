        ...
        <div class="bg-light lter b-b wrapper-md mb-10">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <h1 class="font-thin h3 m-0">Add Customer Information</h1>
                ...
                <section class="boxs">
                    ...
                    <div class="boxs-body">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo $baseUri; ?>/account/addNew">
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label">Birth Day</label>
                                <div class="col-sm-8">
                                    <select class="form-control" name="birthday" style="width:100px">
                                        <?php
                                            for($i = 1; $i <= 31; $i++){
                                                $value = $i < 10 ? '0' . $i : $i;
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label">Birth Month</label>
                                <div class="col-sm-8">
                                    <select class="form-control" name="birthmonth" style="width:100px">
                                        <?php
                                            for($i = 1; $i <= 12; $i++){
                                            $value = $i < 10 ? '0' . $i : $i;
