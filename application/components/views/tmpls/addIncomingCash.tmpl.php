        ...
        <div class="bg-light lter b-b wrapper-md mb-10">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <h1 class="font-thin h3 m-0">Add Incoming Cash</h1>
        ...
        <div class="row">
            <div class="col-md-6">
                <section class="boxs">
                    ...
                    <div class="boxs-body">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo $baseUri; ?>/accounting/addIncomingCash">

                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Date</label>
                                <div class="col-sm-10">
                                    <input type="text" name="date" class="form-control"  placeholder="" value="<?php echo date('Y-m-d'); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control"  name="source" placeholder="Income Source..." required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="amount" name="amount" onkeyup="allowNosOnly(this.value, 'amount')" required >
                                </div>
                            </div>
